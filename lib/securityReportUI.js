...
let reportUI = {
		...
		writeAReportFile: function(converter) {
			...
			converter.writeString(reportSummaryGeneral);
			converter.writeString(reportUI.date);
			converter.writeString("  Time: " + reportUI.time);
			converter.writeString(reportSummaryGeneral1);
			
			// Write summary of a web page errors
			converter.writeString(reportWebPage);
			converter.writeString(reportUI.date);
			converter.writeString("  Time: " + reportUI.time);
			converter.writeString(reportWebPage1);
			converter.writeString(webPageURL);
			converter.writeString(tabs.activeTab.url);
			converter.writeString(webPageURL1);
			
			// Write High Severity errors
			converter.writeString(webPageCSP);
			converter.writeString(webPageInsecurePwd);	
			
			// Write Medium severity errors
			converter.writeString(webPageSSLSelf_Signed);
			converter.writeString(webPageSSLInvalid);
			converter.writeString(webPageMixed_Content);
			converter.writeString(webPageInvalidHSTS);
			converter.writeString(webPageReportOnlyCSP);
			
			// Write Low severity errors
			converter.writeString(webPageDepricatedCSP);
			converter.writeString(webPageDepricatedReportOnlyCSP);
			converter.writeString(webPageInlineScriptInCSP);
			converter.writeString(webPageInlineStyleInCSP);
			converter.writeString(webPageEvalInCSP);
			converter.writeString(webPageDepricateInlineScriptCSP);
			converter.writeString(webPageDepricateEvalCSP);
			converter.writeString(webPageNonStdXhrDirCSP);
			converter.writeString(webPageNonStdAncesDirCSP);			
			
			// Write Log Level errors
			converter.writeString(webPageMissingHTTPS);
			converter.writeString(webPageMissingHSTS);
			converter.writeString(webPageMissingX_Frame_Options);
			converter.writeString(webPageSSLUnknownIssuer);
			converter.writeString(webPageSSLMissingChain);
			converter.writeString(webPageSSLCaInvalid);
			converter.writeString(webPageSSLIssuer);
			converter.writeString(webPageSSLSignatureAlgorithmDisabled);
			converter.writeString(webPageSSLExpiredIssuer);
			converter.writeString(webPageSSLUntrusted);
			converter.writeString(webPageSSLcertErrorMismatch);
			converter.writeString(webPageSSLcertErrorExpiredNow);
			converter.writeString(webPageSSLcertErrorNotYetValidNow);
			converter.writeString(webPageSSLNotACACert);
			converter.writeString(webPageSSLNotImportingUnverifiedCert);
			converter.writeString(webPageSSLBad_Key);
			converter.writeString(webPageSSLBad_Signature);
			converter.writeString(webPageSSLRevoked_Certificate);
...
var reportSummaryGeneral = "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01//E\" \"http://www.w3.org/TR/html4/strict.dtd\"> <html><head> " +
...
var reportSummaryGeneral1 = "</td> </tr> </table>";

var reportWebPage = "<h1>Results per Web Page</h1>" +
		"<h2 id=\"10.15.10.6\">Web Page 10.15.10.6</h2>" +
				"<table> " +
				"<tr>" +
				"<td>Scanning of this host started at:</td>" +
				" <td> "; 
var reportWebPage1 = "</td>" +
				"</tr>" +
				"<tr>" +
...
var webPageURL = "<h3>Security Issues for web page  "; 
var webPageURL1 = 	" </h3>";
	
// ------------------------------------------------------------------------------------
// High Severity Errors Should go here
var webPageCSP = "<div style=\"background:#cb1d17; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
...
var webPageInsecurePwd = "<div style=\"background:#cb1d17; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
		"<div style=\"float:right; text-align:right\">Severity Level: High</div>" +
...
var webPageSSLInvalid = "<div style=\"background:#f99f31; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
...
var webPageSSLSelf_Signed = "<div style=\"background:#f99f31; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Medium</div>" +
...
var webPageMixed_Content = "<div style=\"background:#f99f31; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Medium</div>" +
"<b>Mixed Content</b>" +
"  <div style=\"width: 100%\">" +
"     </div>" +
...
var webPageInvalidHSTS = "<div style=\"background:#f99f31; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Medium</div>" +
...
var webPageReportOnlyCSP = "<div style=\"background:#f99f31; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Medium</div>" +
"<b>Report-only CSP</b>" +
"  <div style=\"width: 100%\">" +
"     </div>" +
...
var webPageDepricatedCSP = "<div style=\"background:#539dcb; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
...
var webPageDepricatedReportOnlyCSP = "<div style=\"background:#539dcb; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Low</div>" +
...
var webPageInlineScriptInCSP = "<div style=\"background:#539dcb; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Low</div>" +
...
var webPageInlineStyleInCSP = "<div style=\"background:#539dcb; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Low</div>" +
...
var webPageEvalInCSP = "<div style=\"background:#539dcb; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Low</div>" +
"<b>Eval Allowed</b>" +
"                  <div style=\"width: 100%\">" +
"          </div>" +
...
var webPageDepricateInlineScriptCSP = "<div style=\"background:#539dcb; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Low</div>" +
...
var webPageDepricateEvalCSP = "<div style=\"background:#539dcb; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Low</div>" +
...
var webPageNonStdXhrDirCSP = "<div style=\"background:#539dcb; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Low</div>" +
...
var webPageNonStdAncesDirCSP = "<div style=\"background:#539dcb; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Severity Level: Low</div>" +
...
var webPageMissingHTTPS = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
...
var webPageMissingHSTS = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
		"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageMissingX_Frame_Options = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLUnknownIssuer = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLMissingChain = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLCaInvalid = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLIssuer = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLSignatureAlgorithmDisabled = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLExpiredIssuer = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLUntrusted = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLcertErrorMismatch = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLcertErrorExpiredNow = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLcertErrorNotYetValidNow = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLNotACACert = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLNotImportingUnverifiedCert = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLBad_Key = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLBad_Signature = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
...
var webPageSSLRevoked_Certificate = "<div style=\"background:#d5d5d5; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
"<div style=\"float:right; text-align:right\">Log</div>" +
