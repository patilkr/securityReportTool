...
// High level error boolean variable object
function highErrorsState() {
	this.webPageCSP = false;
	this.webPageInsecurePwd =  false;
}

// Medium level error boolean variable object
...
// Low level boolean variable object
...
// Log level boolean variable object
		...
		writeAReportFile: function(converter) {
			...
			try {
				...
				for (var i = 0; i < reportUI.webpageList.length; i++) {
					...
					// index value 0
					if (reportUI.secReport[tempWebPageUrl][0].webPageCSP && !reportUI.secReport[tempWebPageUrl][2].webPageDepricatedCSP)
