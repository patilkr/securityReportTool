...
/*
 * // tabs.on('ready', function(tab){ // try { // if (!reportUI.panelWin ||
 * typeof(reportUI.panelWin) === "undefined") return;
 *  // reportUI.CSP = ""; // reportUI.CORS = ""; // reportUI.SSL = ""; //
 * reportUI.Mixed_content = ""; // reportUI.Sec_headers = "";
 *  // } catch (e) {
 *  // } // });
 */
