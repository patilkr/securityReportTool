...
// case 1:
// reportUI.panelWin.document.getElementById('logTextarea').value =
// reportUI.CSP;
// break;
// case 2:
// reportUI.panelWin.document.getElementById('logTextarea').value =
...
let reportUI = {
		init: function(iframeWindow, aToolbox) {
			...
			this.logAllErrorsFlag = true; // switch to false to disable logging
																		// everything
			...
			reportUI.panelWin.document.documentElement.addEventListener("downloadReport-message", function(event) {
				dump("\n Inside callback Function of Download Event\n");
				try {
...
// Low severity errors should go here
	...
	if (!ss.storage.secReportToolStrs["webPageCookieSec"]) {
		...
		"<br /> Hence, cookies are allowed to be sent to HTTP site." +
...
// Log level errors should go here
	...
	if (!ss.storage.secReportToolStrs["webPageMissingHSTS"]) {
		...
		"</div>" +
		"<div style=\"padding:4px; margin:3px; margin-bottom:0px; margin-top:0px; border: 1px solid #CCCCCC; border-top: 0px;\"><pre>" +
		"Web page is not enforcing HSTS using <a href=\"http://en.wikipedia.org/wiki/HTTP_Strict_Transport_Security\"><i>Strict-Transport-Security</i></a> header." +
		"<br /> That is, if website has https version but users access it through http then " +
		"<br /> browsers will talk to HTTP version of the website before they can be redirected to HTTPS. " +
	...
	if (!ss.storage.secReportToolStrs["webPageSSLUnknownIssuer"]) {
		...
		"</div>" +
		"<div style=\"padding:4px; margin:3px; margin-bottom:0px; margin-top:0px; border: 1px solid #CCCCCC; border-top: 0px;\"><pre>" +
		"The certificate used by this website is not trusted because <br /> the issuer certificate is unknown." +
		"</pre></div>";
	}
	...
	if (!ss.storage.secReportToolStrs["webPageSSLCaInvalid"]) {
		...
		"</div>" +
		"<div style=\"padding:4px; margin:3px; margin-bottom:0px; margin-top:0px; border: 1px solid #CCCCCC; border-top: 0px;\"><pre>" +
		"The certificate used by this website is not trusted because <br /> it was issued by an invalid Certificate Authority (CA) certificate." +
		"</pre></div>";
	}
	...
	if (!ss.storage.secReportToolStrs["webPageSSLSignatureAlgorithmDisabled"]) {
		...
		"</div>" +
		"<div style=\"padding:4px; margin:3px; margin-bottom:0px; margin-top:0px; border: 1px solid #CCCCCC; border-top: 0px;\"><pre>" +
		"The certificate used by this website is not trusted because <br /> it was signed using a signature algorithm that was disabled because that algorithm is not secure." +
		"</pre></div>";
	}
...
// var tempWebPageUrl = "";
// for (var i = 0; i < reportUI.webpageList.length; i++) {
// document.write(ss.storage.secReportToolStrs["reportWebPage"]);
// document.write(reportUI.webpageList[i]);
// document.write(ss.storage.secReportToolStrs["reportWebPage1"]);
// document.write(reportUI.date);
// document.write(" Time: " + time);
// document.write(ss.storage.secReportToolStrs["reportWebPage2"]);
// // write number of errors found on this web page
// document.write(reportUI.secReport[reportUI.webpageList[i]][4]);
// document.write(ss.storage.secReportToolStrs["reportWebPage3"]);
// document.write(ss.storage.secReportToolStrs["webPageURL"]);
// document.write(reportUI.webpageList[i]);
// document.write(ss.storage.secReportToolStrs["webPageURL1"]);
//				
// tempWebPageUrl = reportUI.webpageList[i];
// // dump("\n tempWebPageUrl = " + tempWebPageUrl);
//				
...
// // index value 0
// if (reportUI.secReport[tempWebPageUrl][0].webPageCSP)
// document.write(ss.storage.secReportToolStrs["webPageCSP"]);
// if (reportUI.secReport[tempWebPageUrl][0].webPageInsecurePwd)
// document.write(ss.storage.secReportToolStrs["webPageInsecurePwd"]);
//
// // Write Medium severity errors
// // index value 1
// if (reportUI.secReport[tempWebPageUrl][1].webPageSSLSelf_Signed)
// document.write(ss.storage.secReportToolStrs["webPageSSLSelf_Signed"]);
// if (reportUI.secReport[tempWebPageUrl][1].webPageSSLInvalid)
// document.write(ss.storage.secReportToolStrs["webPageSSLInvalid"]);
// if (reportUI.secReport[tempWebPageUrl][1].webPageMixed_Content)
// document.write(ss.storage.secReportToolStrs["webPageMixed_Content"]);
// if (reportUI.secReport[tempWebPageUrl][1].webPageInvalidHSTS)
// document.write(ss.storage.secReportToolStrs["webPageInvalidHSTS"]);
// if (reportUI.secReport[tempWebPageUrl][1].webPageReportOnlyCSP)
// document.write(ss.storage.secReportToolStrs["webPageReportOnlyCSP"]);
//
// // Write Low severity errors
// // index value 2
// if (reportUI.secReport[tempWebPageUrl][2].webPageDepricatedCSP)
// document.write(ss.storage.secReportToolStrs["webPageDepricatedCSP"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageDepricatedReportOnlyCSP)
// document.write(ss.storage.secReportToolStrs["webPageDepricatedReportOnlyCSP"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageInlineScriptInCSP)
// document.write(ss.storage.secReportToolStrs["webPageInlineScriptInCSP"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageInlineStyleInCSP)
// document.write(ss.storage.secReportToolStrs["webPageInlineStyleInCSP"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageEvalInCSP)
// document.write(ss.storage.secReportToolStrs["webPageEvalInCSP"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageDepricateInlineScriptCSP)
// document.write(ss.storage.secReportToolStrs["webPageDepricateInlineScriptCSP"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageDepricateEvalCSP)
// document.write(ss.storage.secReportToolStrs["webPageDepricateEvalCSP"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageNonStdXhrDirCSP)
// document.write(ss.storage.secReportToolStrs["webPageNonStdXhrDirCSP"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageNonStdAncesDirCSP)
// document.write(ss.storage.secReportToolStrs["webPageNonStdAncesDirCSP"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageCookieSec)
// document.write(ss.storage.secReportToolStrs["webPageCookieSec"]);
// if (reportUI.secReport[tempWebPageUrl][2].webPageCookieHttpOnly)
// document.write(ss.storage.secReportToolStrs["webPageCookieHttpOnly"]);
//				
// // Write Log Level errors
// // index value 3
// if (reportUI.secReport[tempWebPageUrl][3].webPageMissingHTTPS)
// document.write(ss.storage.secReportToolStrs["webPageMissingHTTPS"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageMissingHSTS)
// document.write(ss.storage.secReportToolStrs["webPageMissingHSTS"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageMissingX_Frame_Options)
// document.write(ss.storage.secReportToolStrs["webPageMissingX_Frame_Options"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLUnknownIssuer)
// document.write(ss.storage.secReportToolStrs["webPageSSLUnknownIssuer"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLMissingChain)
// document.write(ss.storage.secReportToolStrs["webPageSSLMissingChain"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLCaInvalid)
// document.write(ss.storage.secReportToolStrs["webPageSSLCaInvalid"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLIssuer)
// document.write(ss.storage.secReportToolStrs["webPageSSLIssuer"]);
// if
// (reportUI.secReport[tempWebPageUrl][3].webPageSSLSignatureAlgorithmDisabled)
// document.write(ss.storage.secReportToolStrs["webPageSSLSignatureAlgorithmDisabled"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLExpiredIssuer)
// document.write(ss.storage.secReportToolStrs["webPageSSLExpiredIssuer"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLUntrusted)
// document.write(ss.storage.secReportToolStrs["webPageSSLUntrusted"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLcertErrorMismatch)
// document.write(ss.storage.secReportToolStrs["webPageSSLcertErrorMismatch"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLcertErrorExpiredNow)
// document.write(ss.storage.secReportToolStrs["webPageSSLcertErrorExpiredNow"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLcertErrorNotYetValidNow)
// document.write(ss.storage.secReportToolStrs["webPageSSLcertErrorNotYetValidNow"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLNotACACert)
// document.write(ss.storage.secReportToolStrs["webPageSSLNotACACert"]);
// if
// (reportUI.secReport[tempWebPageUrl][3].webPageSSLNotImportingUnverifiedCert)
// document.write(ss.storage.secReportToolStrs["webPageSSLNotImportingUnverifiedCert"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLBad_Key)
// document.write(ss.storage.secReportToolStrs["webPageSSLBad_Key"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLBad_Signature)
// document.write(ss.storage.secReportToolStrs["webPageSSLBad_Signature"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLRevoked_Certificate)
// document.write(ss.storage.secReportToolStrs["webPageSSLRevoked_Certificate"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageSSLUsageNotAllowed)
// document.write(ss.storage.secReportToolStrs["webPageSSLUsageNotAllowed"]);
// if (reportUI.secReport[tempWebPageUrl][3].webPageCSPViolations)
// document.write(ss.storage.secReportToolStrs["webPageCSPViolations"]);
//				
// } // end of For loop for web page list
//
// // complete HTML tag
