...
var webPageSSLInvalid = "<div style=\"background:#f99f31; padding:4px; margin:3px; margin-bottom:0px; color: #FFFFFF; border: 1px solid #CCCCCC; border-bottom: 0px;\">" +
		...
		"<p>Vulnerability Insight:</p>" +
		" &nbsp;- The web page is using an Invalid Certificate that allows an attacker to perform man-in-the-middle (MITM) attack." +  
		"<p>Fix: </p>" +
...
"<p>Vulnerability Insight:</p>" +
" &nbsp;- The web page is using a self-signed certificate that allows an attacker to perform man-in-the-middle (MITM) attack." +  
"<p>Fix: </p>" +
" Use a valid certificate from a trusted certificate authority (CA)." +
"</pre></div>" +
"<div style=\"padding:4px; margin:3px; margin-bottom:0px; margin-top:0px; border: 1px solid #CCCCCC; border-top: 0px;\">" +
...
"If you want to include third-party content into your secure website then serve all the content as HTTPS instead of HTTP." +
"</pre></div>" +
"<div style=\"padding:4px; margin:3px; margin-bottom:0px; margin-top:0px; border: 1px solid #CCCCCC; border-top: 0px;\">" +
"<b>References</b><br><table>" +
"<tr valign=\"top\"> " +
...
"<p>Vulnerability Insight:</p>" +
" &nbsp;- The web page is using an invalid HTTP Strict Transport Security (HSTS) format. <br />Thus fails to instruct browser HTTPS enforcemnet on non-secure links." +  
"<p>Fix: </p>" +
...
"<br /> Non-standard headers are comptible with all web browsers. <br />According to W3C recommendation, you must use standard header (i.e Content-Security-Policy) for CSP enforcement." +
...
"</div>" +
"<div style=\"padding:4px; margin:3px; margin-bottom:0px; margin-top:0px; border: 1px solid #CCCCCC; border-top: 0px;\"><pre>" +
"Web page is not using HTTPS version or fails to redirect to HTTPS when users visited non-secure (HTTP) version." +
...
"<br /> Sites can use this to avoid Clickjacking attacks, by ensuring that their content is not embedded into other sites." +
