...
var errorListener = {
  ...
  try {
  	...
  	if (error instanceof Ci.nsISecurityConsoleMessage) {
  		dump("\n\n nsISecurityConsoleMessage instance found !!!!! Eureka");
...
// Register event listener for console message service to captrue msg
 ...
 var securityErrorListener = {
		  ...
		  try {
		  	let error = aMessage.QueryInterface(Ci.nsISecurityConsoleMessage);
		  	if (error instanceof Ci.nsISecurityConsoleMessage) {
		  		dump("\n\n\n SEC: nsISecurityConsoleMessage instance found !!!!! Correct");
...
// // Register event listener for security error console massage service to
// capture
// // msg
